...
public class TestClassConnector {
	...
	String tsJoin = String.format("%s JOIN (%s) ON (timestamp)",
			timeseriesContentAggHourly, timeseriesUniqCount);
	...
	public void testComplexQuery() throws Exception {
		...
		Either<List<TimeSeriesBean>, Map<Object, TimeSeriesBean>> goodResult = mapperRes
				.right().get();
